...
func_programa_plot2(   STD15,MEAN15,AVD15,...
                       ...
                       STD45,MEAN45,AVD45,...
                       STD60,MEAN60,AVD60,...
                       TIME,'dir_FPS_f11_raw','FPS_f11_raw');
...
func_programa_plot2(   STD15/max(STD15),MEAN15,AVD15/max(AVD15),...
                       ...
                       TIME,'dir_FPS_f11_norm1','FPS_f11_norm1');

func_programa_plot2(   STD15/mean(MEAN15),MEAN15,AVD15/mean(MEAN15),...
                       STD30/mean(MEAN30),MEAN30,AVD30/mean(MEAN30),...
                       STD45/mean(MEAN45),MEAN45,AVD45/mean(MEAN45),...
                       STD60/mean(MEAN60),MEAN60,AVD60/mean(MEAN60),...
                       TIME,'dir_FPS_f11_norm2','FPS_f11_norm2');
